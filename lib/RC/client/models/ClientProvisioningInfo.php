...
class ClientProvisioningInfo implements ArrayAccess {
  static $swaggerTypes = array(
      'web_uris' => 'ClientProvisioningWebUriInfo',
  ...
  * @var ClientProvisioningWebUriInfo
  */
  public $web_uris;
  /**
  * Informs client application on the required user action
  * @var ClientProvisioningHintsInfo
  */
  public $hints;

  public function __construct(array $data = null) {
    $this->web_uris = $data["web_uris"];
